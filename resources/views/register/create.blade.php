...
<input class="border border-gray-400 p-2 w-full" type="password" name="passwordrepeat" id="passwordrepeat" required>
@error('passwordrepeat')
<p class="text-red-500 text-ms mt-1">{{ $message }}</p>
@enderror
</div>
<button class="bg-pink-400 text-white rounded py-2 px-4 hover:bg-pink-600" type="submit">Submit</button>
